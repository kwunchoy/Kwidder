...
- Line items can target device types, operating systems, browser families, and exact-match geo filters for country, region, city, and ZIP
...
Then open `http://localhost:8080/ui` to create line items with media type, bid CPM, budget, device type targeting, operating system targeting, browser family targeting, and geo targeting, paste a bid request, and inspect Kwidder's response in the browser.
